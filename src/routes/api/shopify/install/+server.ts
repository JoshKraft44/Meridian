...
const SCOPES = 'read_all_orders,read_fulfillments,read_inventory,read_orders,read_products,read_shipping,read_shopify_payments_accounts,read_shopify_payments_payouts';
